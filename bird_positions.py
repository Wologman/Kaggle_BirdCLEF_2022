# Find the positions of the hawaiian birds within the list


all_birds = 'afrsil1 akekee akepa1 akiapo akikik amewig aniani apapan arcter \
...
hawaiian_birds = ["akiapo", "aniani", "apapan", "barpet", "crehon", "elepai", "ercfra", "hawama", "hawcre", "hawgoo", "hawhaw", 
                 "hawpet1", "houfin", "iiwi", "jabwar", "maupar", "omao", "puaioh", "skylar", "warwhe1", "yefcan"]


index_list=[]
for bird in hawaiian_birds:
    index_list.append(all_birds.index(bird))
